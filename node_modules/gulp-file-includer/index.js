    ...
    function includer(file) {
        ...
        if (file.isNull()) {
            ...
            file.contents.pipe(concat(function (data) {
                ...
                self.emit('data', include(file, text, includeRegExp, options.prefix, options.suffix, options.basePath, options.def, options.doT));
            }));
        } else if (file.isBuffer()) {
            try {
                self.emit('data', include(file, String(file.contents), includeRegExp, options.prefix, options.suffix, options.basePath, options.def, options.doT));
            } catch (e) {
...
function include(file, text, includeRegExp, prefix, suffix, basePath, def, _doT) {
