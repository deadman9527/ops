 ...
 * Transform module
 */
var transform = module.exports = function (filepath, i, length, sourceFile, targetFile, v) {
  var type;
...
transform.html.css = function (filepath) {
  return '<link rel="stylesheet" href="' + filepath + (arguments[5]?"?v="+arguments[5]:"") + '"' + end();
};

transform.html.js = function (filepath) {
  return '<script src="' + filepath + (arguments[5]?"?v="+arguments[5]:"") + '"></script>';
};
